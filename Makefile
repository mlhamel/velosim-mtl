...
help:
	...
	@echo "  $(CYAN)run-population$(RESET)   - Run large-scale population simulation (default: 100)"
	@echo "  $(CYAN)run-temporal$(RESET)     - Run 5-day weather/policy simulation (default: 10)"
	@echo ""
	@echo "$(BOLD)$(WHITE)⚙  ENVIRONMENT VARIABLES:$(RESET)"
	@echo "  $(CYAN)VELOSIM_POP_SIZE$(RESET)  - Override population size (e.g. VELOSIM_POP_SIZE=500 make run-population)"
	@echo ""
